<p align='center'>
  <img src="https://capsule-render.vercel.app/api?type=waving&color=gradient&customColorList=0,2,3&height=300&section=header&text=Kim%20Hyobin's%20GitHub&fontSize=90&animation=fadeIn&fontAlignY=38&desc=|%20Java%20Fullstack%20Training&descAlignY=60&descAlign=62"/>
</p>
...
> 🚀 **자바 & 클라우드 활용 풀스택 개발자 과정**  
> 2024.05.07 ~ 2024.11.25

- STS 기반 Spring 웹 프로젝트 실습  
- React & JavaScript로 동적 UI 및 상태 관리 구현  
- Oracle DB로 데이터 연동 및 쿼리 최적화  
- Java 기반 백엔드와 프론트 통합 풀스택 개발  
- 🏆 훈련기관 출석우수자 → 취업 추천서 수여

---

<div align="center">
  <h2>
    <img src="https://raw.githubusercontent.com/Tarikul-Islam-Anik/Animated-Fluent-Emojis/master/Emojis/Smilies/Dizzy.png" width="25"/> STACKS <img src="https://raw.githubusercontent.com/Tarikul-Islam-Anik/Animated-Fluent-Emojis/master/Emojis/Smilies/Dizzy.png" width="25"/>
  </h2>
</div>
...
<table>
  <tr>
    <td width="50%" valign="top" style="padding: 10px;">
      ...
      - 백엔드: 로그인, 회원탈퇴, 리뷰 등록/삭제<br>
      - 프론트엔드: API 호출, 페이징 처리<br>
